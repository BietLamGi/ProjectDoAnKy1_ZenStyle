            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="TotalAmount" class="form-control" step="0.01" min="0"
                        value="{{ old('TotalAmount', $invoice->TotalAmount) }}" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="DiscountAmount" class="form-control" step="0.01" min="0"
                        value="{{ old('DiscountAmount', $invoice->DiscountAmount) }}" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="FinalAmount" class="form-control" step="0.01" min="0"
                        value="{{ old('FinalAmount', $invoice->FinalAmount) }}" required>
                </div>
