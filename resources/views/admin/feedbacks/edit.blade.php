...
<div class="card">
    <div class="card-body">
        ...
        <form
            action="{{ route('feedbacks.update', $feedback->FeedbackID) }}"
            method="POST"
        >
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    >
                        ...
                        <option
                            value="5"
                            {{ old('Rating', $feedback->Rating) == 5 ? 'selected' : '' }}
                        >
                            ★★★★★ - Excellent
                        </option>
                        ...
                        <option
                            value="4"
                            {{ old('Rating', $feedback->Rating) == 4 ? 'selected' : '' }}
                        >
                            ★★★★☆ - Very Good
                        </option>
                        ...
                        <option
                            value="3"
                            {{ old('Rating', $feedback->Rating) == 3 ? 'selected' : '' }}
                        >
                            ★★★☆☆ - Good
                        </option>
                        ...
                        <option
                            value="2"
                            {{ old('Rating', $feedback->Rating) == 2 ? 'selected' : '' }}
                        >
                            ★★☆☆☆ - Fair
                        </option>
                        ...
                        <option
                            value="1"
                            {{ old('Rating', $feedback->Rating) == 1 ? 'selected' : '' }}
                        >
                            ★☆☆☆☆ - Poor
                        </option>
                ...
                <div class="col-12 mb-3">
                    ...
                    >{{ old('Comments', $feedback->Comments) }}</textarea>
                </div>
