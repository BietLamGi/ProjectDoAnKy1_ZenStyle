        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center" data-animate-effect="fadeInUp">
                ...
                <p>
                    ...
                    <a href="{{ route('services') }}" class="btn btn-white btn-outline-white px-4 py-3">View Services</a>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-6 pl-md-5 py-5 ftco-animate" data-animate-effect="fadeInRight">
                ...
                <ul class="list-unstyled mt-3">
                    ...
                    <li class="mb-2"><span class="icon-check mr-2 text-primary"></span> Premium and authentic products</li>
                    <li class="mb-2"><span class="icon-check mr-2 text-primary"></span> Luxury and private environment</li>
                    <li class="mb-2"><span class="icon-check mr-2 text-primary"></span> Fast and convenient online booking</li>
                </ul>
