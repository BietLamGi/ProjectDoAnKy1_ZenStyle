...
<div class="container-fluid">
    ...
    <div class="page-heading">
        <div>
            ...
            <p class="text-muted mb-0">{{ $customer->Phone }} @if($customer->Email) &middot; {{ $customer->Email }}
                @endif</p>
        </div>
        <div class="heading-actions">
            <a href="{{ route('receptionist.appointments.create', ['customer_id' => $customer->CustomerID]) }}"
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $appointment->AppointmentDate?->format('d/m/Y') }}</td>
                                <td>{{ \Illuminate\Support\Carbon::parse($appointment->StartTime)->format('H:i') }}</td>
                                <td>{{ $appointment->services->pluck('service.ServiceName')->filter()->join(', ') ?: '—' }}
                                </td>
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a
                                        href="{{ route('receptionist.invoices.show', $invoice) }}">#{{ $invoice->InvoiceID }}</a>
                                </td>
