        ...
        <div class="cart-layout">
                ...
                <div class="cart-item">
                    ...
                    <div class="cart-product-price">
                        ...
                        <strong class="text-danger">
                            {{ number_format($item['discounted_price']) }} VND
                        </strong>
                        @else
                        <strong>
                            {{ number_format($item['price']) }} VND
            ...
            <div class="cart-summary">
                ...
                <div class="cart-summary-product">
                    ...
                    <div>
                        ...
                        <small class="text-danger d-block">
                            ...
                            ({{ $item['promotion']->DiscountType === 'Percent'
                            ? $item['promotion']->DiscountValue . '%'
                            : number_format($item['promotion']->DiscountValue) . ' VND' }})
                        </small>
                        @endif
                    </div>
                ...
                <div class="cart-summary-row">
                    ...
                    <strong class="text-danger">
                        -{{ number_format($originalTotal - $total) }} VND
                    </strong>
